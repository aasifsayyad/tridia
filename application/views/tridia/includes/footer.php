...
<script src="<?php echo base_url();?>assets/js/popper.min.js" type="text/javascript"></script>
  ...
  <!--<script src="<?php echo base_url();?>assets/js/output.min.js" type="text/javascript"></script>-->
  ...
  <script src="<?php echo base_url();?>assets/Views/Angular/config.js" type="text/javascript"></script>
  <script src="<?php echo base_url();?>assets/Views/Angular/app.js" type="text/javascript"></script>
  <script src="<?php echo base_url();?>assets/Views/Angular/summaryController.js" type="text/javascript"></script>
  <script src="<?php echo base_url();?>assets/Views/Angular/masterController.js" type="text/javascript"></script>
  <script src="<?php echo base_url();?>assets/Views/Angular/allocationController.js" type="text/javascript"></script>
  <script src="<?php echo base_url();?>assets/Views/Angular/assetdesignController.js" type="text/javascript"></script>
